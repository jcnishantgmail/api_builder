module.exports = {
  onBoarding: {
    ...
    VERIFICATION_CODE_SENT: "Please check your email to reset password using link.",
  ...
  CATEGORY: {
    ...
    ALREADY_EXIST: "Category already exist.",
    CREATED: "Category created successfully.",
    SUB_ALREADY_EXIST: "Sub category already exist.",
    SUB_CREATED: "Sub category created successfully.",
    ID_MISSING: "Id required.",
    UPDATED: "Category updated successfully.",
    SUB_UPDATED: "Sub category updated successfully.",
    DELETED: "Category deleted successfully.",
  ...
  discounts: {
    PAYLOAD_MISSING: "Payload  missing.",
    ALREADY_EXIST: "Discount already exist.",
  ...
  CMS: {
    PAYLOAD_MISSING: "Payload  missing.",
    ALREADY_EXIST: "CMS already exist.",
    CREATED: "CMS created successfully.",
    ID_MISSING: "Id required.",
    UPDATED: "CMS updated successfully.",
