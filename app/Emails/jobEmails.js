...
jobCompleteEmailToAdmin = (options) => {   
...
expenseAddedEmailToAdmin = (options) => {   
                    ...
                    <table width="640px" cellpadding:"0" cellspacing="0" style="margin: 0 auto;background: #DEEFFF;border-radius: 0px 0px;padding: 0px 48px 108px;">
                        ...
                        <tr>
                            <td style="background-color: #fff;padding: 40px 32px;">
                               ...
                               <p style="font-size: 16px;font-weight: 400;color: #384860;line-height: 21px;padding-right: 31px;margin-top: 0px;">This is to notify you that <strong>${options.contractorFullName}</strong> has added expense for the job titled <strong>${options.jobTitle}</strong>/p>
